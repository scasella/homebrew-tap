...
Homebrew tap for scasella's native macOS menu bar apps. All apps are signed, notarized, and stapled — zero Gatekeeper warnings.
...
|------|-------------|------|
| `clipdrop` | Clipboard-to-file menu bar app — read, edit, and save clipboard text to 8 file formats | [ClipDrop](https://github.com/scasella/ClipDrop) |
